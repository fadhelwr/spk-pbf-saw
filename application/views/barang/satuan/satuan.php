    ...
    <div class="col-sm-6">
        ...
        <div class="table-responsive m-b-20">
            ...
            <div style="margin-bottom: 0px;">
                <a href="<?=base_url()?>barang/tambah_satuan"  class="btn btn-primary"><i class="ti-plus"></i></a>
            </div>
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: center;" width="10">
                        <a href="<?=base_url()?>barang/edit_satuan/?id=<?=$rowdata->id_satuan;?>" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-pencil"></i></a>
