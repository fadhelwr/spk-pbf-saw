...
<div class="body">
    <form id="form_validation" method="POST" action="<?=base_url()?>barang/updatesatuan/?id=<?=$row->id_satuan?>">
        <div class="col-sm-4">
            <label for="">Nama Satuan</label>
            <div class="form-group">
                <div class="form-line">
                    <input type="text" class="form-control" name="namasatuan" value="<?=$row->nama_satuan?>" required/>
                </div>
            </div>
        </div>
