...
<div class="row">
    <div class="col-sm-12">
        <h4 class="header-title m-t-0 m-b-20">Tambah Barang</h4>
    </div>
</div> <!-- end row -->

<div class="body">
    <form id="form_validation" method="POST" action="<?=base_url()?>barang/simpan_baru">
        <div class="col-sm-2">
        ...
        <div class="col-sm-2">
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="number" class="form-control" name="hrg_jual" placeholder="" id="harga_jual" onkeyup="sum()">
                </div><!-- input-group -->
            </div>
        </div>
        ...
        <div class="col-sm-2">
            ...
            <div class="form-group">
                <div class="input-group">
                    <span class="input-group-addon bg-primary" style="color: #FFF">Rp</span>
                    <input type="number" class="form-control" name="hrg_beli" placeholder="" id="harga_beli" onkeyup="sum()">
                </div><!-- input-group -->
            </div>
        </div>
        ...
        <div class="col-sm-2">
            ...
            <div class="form-group">
                <div class="input-group">
                    <span class="input-group-addon bg-primary" style="color: #FFF">Rp</span>
                    <input type="number" class="form-control" name="profit" readonly="" id="profit" onkeyup="sum()">
                </div><!-- input-group -->
            </div>
        </div>
        ...
        <div class="col-sm-4">
            ...
            <div class="form-group">
                <div class="form-line">
                    <input type="text" class="form-control" name="kandungan" required/>
                </div>
            </div>
        </div>
