  ...
  <div class="col-sm-12">
    ...
    <div class="table-responsive m-b-20">
      <div style="margin-bottom: 0px;">
        <a href="<?=base_url()?>suratpesanan/tambah-prekursor"  class="btn btn-primary"><i class="ti-plus"></i></a>
      </div>
      <br>
                  ...
                  <td colspan="6">
                    ...
                    <div class="col-sm-4">
                      ...
                      <span style="text-align: center;margin-right: 0px">
                         ...
                         <a href="<?=base_url().'suratpesanan/edit-statuspre/'.$rowdata->kode_trx?>" class="btn btn-xs btn-rounded btn-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Tinjau">
                          <i class="mdi mdi-grease-pencil"></i>
                        </a>

                        <a href="<?=base_url()?>suratpesanan/cetakprekursor/?kode=<?=$rowdata->kode_trx?>" class="btn btn-xs btn-rounded btn-success" data-toggle="tooltip" data-placement="top" title="" data-original-title="Cetak">
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <a href="<?php echo base_url().'suratpesanan/hapuspre/'.$rowdata->kode_trx;?>" type="submit" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i> Hapus</a>
                              </div>
                            </div><!-- /.modal-content -->
                    ...
                    <div class="collapse" id="collapseExample<?=$rowdata->kode_trx;?>" style="margin-top: 40px">
                      <div class="card card-body">
                        ...
                        $kd = $rowdata->kode_trx;
                        $no = 1;
                        $sql= "SELECT nama_barang, status FROM tb_pembelian_detail_pre
                        INNER JOIN tb_barang 
                        ON tb_pembelian_detail_pre.kode_barcode=tb_barang.kode_barcode
                        AND tb_pembelian_detail_pre.kode_trx='$kd'";
